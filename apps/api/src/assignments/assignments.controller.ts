...
export class AssignmentsController {
  ...
  acknowledge(@Param('id', ParseUUIDPipe) id: string, @Body() dto: AcknowledgeDto, @CurrentUser() user: AuthUser) {
    return this.assignments.acknowledge(id, dto, user);
  }

  @Post('assets/:id/assign')
  @RequirePermissions('asset.assign')
  assign(@Param('id', ParseUUIDPipe) id: string, @Body() dto: AssignAssetDto, @CurrentUser() user: AuthUser) {
  ...
  returnAsset(@Param('id', ParseUUIDPipe) id: string, @Body() dto: ReturnAssetDto, @CurrentUser() user: AuthUser) {
  ...
  transfer(@Param('id', ParseUUIDPipe) id: string, @Body() dto: TransferAssetDto, @CurrentUser() user: AuthUser) {
